...
const POST_LIST = [ //виводимо дані що повинні відображатись
    {
        category: [
            { 
                text: 'Важливо', id: 1
...
const createPost = () => {
    const postList = createElement('main', 'post__list') //список постів

    POST_LIST.forEach((postData) => { //ітерація постів
        const post = createElement(
            'div',
            postData.viewed ? 'post button post--viewed' : 'post button',
        )

        const postHeader = createElement('div', 'post__header') //сптворюємо post__header
